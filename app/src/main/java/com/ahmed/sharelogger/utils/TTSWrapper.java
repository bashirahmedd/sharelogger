...
public class TTSWrapper extends UtteranceProgressListener {
    ...
    public void speak(String message, boolean talkbackOnly, boolean interrupt) {
        ...
        if (tts != null) {
            if (! talkbackOnly
                ...
                Log.i("TTSWrapper", Integer.toString(Build.VERSION.SDK_INT));
                Log.i("TTSWrapper", Integer.toString(Build.VERSION_CODES.LOLLIPOP));
    ...
    private void ttsGreater21(String text) {
        Log.i("ttsGreater21", text);
        for (String part : splitText(text)) {
            // TODO: uncomment later if spoken content required
